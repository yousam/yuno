...
- (id)initWithURL:(NSURL *)newURL
{
    ...
    numberOfTimesToRetryOnTimeout = 1;
	return self;
}
...
- (NSString *)responseString
{
	...
	NSString *rawString=[[[NSString alloc]initWithData:data encoding:enc]autorelease];  
	return rawString;
...
-(void)startAsynchronousAndCancelOther
{
	if ([[sharedQueue operations] count]>0) 
	{
